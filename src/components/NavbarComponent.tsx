            ...
            <nav className="sticky top-0 z-50 bg-white border-gray-200 dark:border-gray-700 component-background-billie">
                <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
                    ...
                    <button
                        ...
                        aria-controls="navbar-dropdown" aria-expanded={menuAbierto ? "true" : "false"}>
                    ...
                    <div className={`${menuAbierto ? 'block' : 'hidden'} w-full md:block md:w-auto`} id="navbar-dropdown">
                        <ul
                            ...
                            <li className="relative">
                                ...
                                <div id="dropdownNavbar"
                                    className={`${desplegableTienda ? 'block' : 'hidden'} absolute z-10 font-normal bg-white divide-y divide-gray-100 rounded-lg shadow w-44 component-background-billie dark:divide-white`}>
                                    <div className="py-1">
                                        <Link to={'/store'}
